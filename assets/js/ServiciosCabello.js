$(document).ready(function () {
    ...
    const urlServiciosCabello= "https://gaeldd2.github.io/API-Stacy-s-Salon/json/serviciosCabello.json";
    $.getJSON(urlServiciosCabello, function (servicios) {
          ...
          <div class="col-md-4">
            <div class="card h-100 shadow border-0 rounded-4 overflow-hidden card-servicio position-relative">
              ...
              <div class="card-body bg-dark text-white">
                ...
                <p class="fw-bold text-warning mb-2">₡${servicio.precio.toLocaleString()}</p>
                <a href="contacto.html?servicio=${encodeURIComponent(servicio.servicio)}" class="btn btn-warning mt-2 boton-reservar" style="display: none;">Reservar</a>
              </div>
            </div>
          </div>
        `;
